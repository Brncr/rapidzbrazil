...
const EMBED_URL = "https://brasil-web3-gateway.lovable.app/streamers";
  ...
  return (
    <div className="min-h-screen flex flex-col p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full flex flex-col h-[calc(100vh-2rem)] md:h-[calc(100vh-4rem)]">
        ...
        <div className="flex-1 rounded-xl md:rounded-2xl overflow-hidden border border-purple-500/20 fade-up min-h-0 relative mb-12 md:mb-0">
          {isLoading && (
            <div className="absolute inset-0 flex items-center justify-center bg-card/80 z-10">
              <Loader2 className="w-6 h-6 md:w-8 md:h-8 text-purple-400 animate-spin" />
              <span className="ml-2 md:ml-3 text-muted-foreground text-sm">Loading streamers...</span>
            </div>
          )}
